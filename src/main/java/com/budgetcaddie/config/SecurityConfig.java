package com.budgetcaddie.config;

import com.budgetcaddie.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    // CORS configuration allowing ONLY the frontend origin (replace with your
    // actual frontend URL)
    @Bean
